...
#define GT1X_PRESSUR_POSITION_MAX_X_AXIS  1080
#define GT1X_PRESSUR_POSITION_MAX_Y_AXIS  1920

#define GT1X_PRESSUR_POSITION_MID_X0   0
#define GT1X_PRESSUR_POSITION_MID_X1   437
#define GT1X_PRESSUR_POSITION_MID_Y0   857
#define GT1X_PRESSUR_POSITION_MID_Y1   1063

#define GT1X_PRESSUR_POSITION_MID_X2   (GT1X_PRESSUR_POSITION_MAX_X_AXIS - GT1X_PRESSUR_POSITION_MID_X1)
#define GT1X_PRESSUR_POSITION_MID_X3   GT1X_PRESSUR_POSITION_MAX_X_AXIS
#define GT1X_PRESSUR_POSITION_MID_Y2   857
#define GT1X_PRESSUR_POSITION_MID_Y3   1063

#define GT1X_PRESSUR_POSITION_UP_X0   0
#define GT1X_PRESSUR_POSITION_UP_X1   231
#define GT1X_PRESSUR_POSITION_UP_Y0   651
#define GT1X_PRESSUR_POSITION_UP_Y1   857

#define GT1X_PRESSUR_POSITION_UP_X2   (GT1X_PRESSUR_POSITION_MAX_X_AXIS - GT1X_PRESSUR_POSITION_UP_X1)
#define GT1X_PRESSUR_POSITION_UP_X3   GT1X_PRESSUR_POSITION_MAX_X_AXIS
#define GT1X_PRESSUR_POSITION_UP_Y2   651
#define GT1X_PRESSUR_POSITION_UP_Y3   857

#define GT1X_PRESSUR_POSITION_DOWN_X0   0
#define GT1X_PRESSUR_POSITION_DOWN_X1   231
#define GT1X_PRESSUR_POSITION_DOWN_Y0   1063
#define GT1X_PRESSUR_POSITION_DOWN_Y1   1269

#define GT1X_PRESSUR_POSITION_DOWN_X2   (GT1X_PRESSUR_POSITION_MAX_X_AXIS - GT1X_PRESSUR_POSITION_DOWN_X1)
#define GT1X_PRESSUR_POSITION_DOWN_X3   GT1X_PRESSUR_POSITION_MAX_X_AXIS
#define GT1X_PRESSUR_POSITION_DOWN_Y2   1063
#define GT1X_PRESSUR_POSITION_DOWN_Y3   1269

#define GT1X_PRESSUR_POSITION_4_RATIO  4
#define GT1X_PRESSUR_POSITION_2_RATIO  2
...
static void gt1x_plus_ratio_in_the_middle_edge_area(const s32 *x, const s32 *y, s32 *z)
{
    if((((*x >= GT1X_PRESSUR_POSITION_MID_X0)&&(*x <= GT1X_PRESSUR_POSITION_MID_X1)) 
    	&& ((*y >= GT1X_PRESSUR_POSITION_MID_Y0)&&(*y <= GT1X_PRESSUR_POSITION_MID_Y1)))
    	|| (((*x >= GT1X_PRESSUR_POSITION_MID_X2)&&(*x <= GT1X_PRESSUR_POSITION_MID_X3)) 
    	&& ((*y >= GT1X_PRESSUR_POSITION_MID_Y2)&&(*y <= GT1X_PRESSUR_POSITION_MID_Y3)))){
    	
        	*z = (*z) * GT1X_PRESSUR_POSITION_4_RATIO;
    }
    else if((((*x >= GT1X_PRESSUR_POSITION_UP_X0)&&(*x <= GT1X_PRESSUR_POSITION_UP_X1)) 
    	&& ((*y >= GT1X_PRESSUR_POSITION_UP_Y0)&&(*y <= GT1X_PRESSUR_POSITION_UP_Y1)))
    	|| (((*x >= GT1X_PRESSUR_POSITION_UP_X2)&&(*x <= GT1X_PRESSUR_POSITION_UP_X3)) 
    	&& ((*y >= GT1X_PRESSUR_POSITION_UP_Y2)&&(*y <= GT1X_PRESSUR_POSITION_UP_Y3)))){
    	
        	*z = (*z) * GT1X_PRESSUR_POSITION_2_RATIO;
    }
    else if((((*x >= GT1X_PRESSUR_POSITION_DOWN_X0)&&(*x <= GT1X_PRESSUR_POSITION_DOWN_X1)) 
    	&& ((*y >= GT1X_PRESSUR_POSITION_DOWN_Y0)&&(*y <= GT1X_PRESSUR_POSITION_DOWN_Y1)))
    	|| (((*x >= GT1X_PRESSUR_POSITION_DOWN_X2)&&(*x <= GT1X_PRESSUR_POSITION_DOWN_X3)) 
    	&& ((*y >= GT1X_PRESSUR_POSITION_DOWN_Y2)&&(*y <= GT1X_PRESSUR_POSITION_DOWN_Y3)))){
    	
        	*z = (*z) * GT1X_PRESSUR_POSITION_2_RATIO;
    }

	/* Need change here if the max value is changed */
    if(*z > 256){
		*z = 256;
     }
	...
	if (CHK_BIT(cur_event, BIT_TOUCH)) {
		...
		for (i = 0; i < GTP_MAX_TOUCH; i++) {
			if (i == id) {
				...
				/* wangjianping 20150929 add Plus a ratio when press the edge in the middle area */
				if(irq_num == 3)
				{
				    GTP_DEBUG("wangjianping First press value,input_x:%d, input_y:%d, input_z:%d\n", input_x, input_y, input_z);
				    gt1x_plus_ratio_in_the_middle_edge_area(&input_x, &input_y, &input_z);
				    GTP_DEBUG("wangjianping First press value plus ratio,input_x:%d, input_y:%d, input_z:%d\n", input_x, input_y, input_z);
				    //irq_num++;
				}
