...
static const struct mmc_fixup blk_fixups[] =
{
	...
	*/
	...
	/*For any EMMC, we enable MMC_QUIRK_SEC_ERASE_TRIM_BROKEN flag.
	* On some emmc parts, performing secure erase can result in erasing is very slow.
	* This problem mostly happen on SAMSUNG chips
	*/
