...
struct mdss_dsi_ctrl_pdata {
	...
	struct workqueue_struct *acl_set_workqueue;
	struct delayed_work acl_set_work;
	struct workqueue_struct *hbm_set_workqueue;
	struct delayed_work hbm_set_work;
	int current_acl_level;
	int current_hbm_level;
	int current_backlight_level;
	/** ZTE_MODIFY end **/
	int bklt_en_gpio;
	int mode_gpio;
