...
struct ak49xx_pdata {
	...
	int num_irqs;
	int reset_gpio;
	int ldoen_gpio;   // add for compile by lvrongguo
	int cif1_gpio;	  // add for compile by lvrongguo
	//int en_2p5_gpio;	  // add by lvrongguo
	...
	struct pinctrl_state *gpio_state_suspend;  // add for compile by lvrongguo
};
