...
u32 ddr_type = 0, ddr_manufacture = 0;
u64 ddr_density = 0;
static char * ddr_type_name[6] = {
	"LPDDR1",
	"Unknowned ddr type",
	"LPDDR2",
	"PCDDR2",
...
static char * ddr_manufacture_name[15] = {
...
static int ddr_id_proc_show(struct seq_file *m, void *v)
{
	...
	seq_printf(m,"%s-NA-NA-%ld%s-%s\n", \
		manufacture_name , ddr_den, uint, ddr_type_name[ddr_type]);
